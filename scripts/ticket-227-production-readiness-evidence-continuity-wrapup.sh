...
verify_readme_and_docs() {
  ...
  grep -q "### Ticket #227" "$README_FILE" || fail "README continuity missing Ticket #227"
  ...
  (( line_current > line_prev )) || fail "README continuity order invalid: Ticket #227 must follow Ticket #199"
}
